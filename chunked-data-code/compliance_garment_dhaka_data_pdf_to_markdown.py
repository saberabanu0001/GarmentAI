#!/usr/bin/env python3
"""
PDF → Markdown: Compliance practices (garment industries, Dhaka).

Defaults:
  raw-data/Compliance_Practices_in_Garment_Industries_in_Dhak.pdf
...
DEFAULT_PDF = REPO_ROOT / "raw-data/Compliance_Practices_in_Garment_Industries_in_Dhak.pdf"
DEFAULT_MD = REPO_ROOT / "md data/3 compliance garment dhaka data.md"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Compliance garment PDF → markdown.")
