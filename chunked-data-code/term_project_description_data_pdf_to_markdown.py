#!/usr/bin/env python3
"""
PDF → Markdown: Term project description (course handout).

Defaults:
  raw-data/Term Project Description .pdf
...
DEFAULT_PDF = REPO_ROOT / "raw-data/Term Project Description .pdf"
DEFAULT_MD = REPO_ROOT / "md data/6 term project description data.md"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Term project PDF → markdown.")
