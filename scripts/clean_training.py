...
clean_training.py
=================
Preprocessing pipeline for Training / Safety Instruction Documents
Workflow: Text Input → Cleaning → Chunking → Save

Source : Any safety / training / instruction webpage
Method : Paste the copied website text into TEXT below

Instructions:
  1. Open your training / safety instruction page in browser
  2. Select all main content text (skip navigation/footer)
  3. Copy it (Ctrl+C)
  4. Paste it into TEXT = \"\"\" ... \"\"\" below
  5. Update SOURCE_URL with the page URL
  6. Run: python scripts/clean_training.py
"""
...
SOURCE     = "Training"
SOURCE_URL = "https://your-training-page-url-here"   # ← update this
CHUNK_SIZE = 1000
OVERLAP    = 100
...
# ─────────────────────────────────────────────
TEXT = """
Paste the training / safety instruction page text here.
...
def clean_text(text):
    # Remove common navigation / cookie / UI elements
    text = re.sub(r'^\s*(Home|Menu|Skip|Login|Register|Search|Cookie|Privacy|Terms|Accept|Decline)[^\n]*\n',
